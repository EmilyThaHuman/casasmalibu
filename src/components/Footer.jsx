    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>123 Pacific Coast Highway</li>
              <li>Malibu, CA 90265</li>
              <li>Phone: (310) 555-0123</li>
              <li>Email: info@casasmalibu.com</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/alimorrisvogt"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/aliwoodtwisp/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Casas Malibu. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
